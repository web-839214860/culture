<template>
	<div class="upload-container">
		...
		<el-dialog :visible.sync="dialogVisible">
			<el-upload :multiple="true" :file-list="fileList" :show-file-list="true" list-type="picture-card" class="editor-slide-upload"
			...
			handleSuccess(response, file) {
				...
				for (let i = 0, len = objKeyArr.length; i < len; i++) {
					if (this.listObj[objKeyArr[i]].uid === uid) {
						...
						this.listObj[objKeyArr[i]].url = this.link + response.data
